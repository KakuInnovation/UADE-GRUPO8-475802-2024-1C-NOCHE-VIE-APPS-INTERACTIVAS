...
const CreateListing = ({handleOpen,handleClose,open,userId, setEditListing,editListing}) => {
    ...
    return(
        <Box sx={{...sx_CreateListing.box}}>
            <Button
                ...
                sx={{background:role !== 'USER'?background:'#e7e7e7', color:'black', boxShadow: '0 0 10px rgba(0, 0, 0, 0.7)',fontFamily:"Tisa Sans Pro Bold",padding:{lg:'15px'}}}
            ...
            <CreateListingDialog open={open} handleClose={handleClose} userId={userId} ></CreateListingDialog>
        </Box>
    )
}
